    ...
    <div className="space-y-8 animate-fade-in pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-card border border-border p-8 rounded-3xl shadow-soft">
        <div>
          ...
          <p className="text-muted-foreground font-bold uppercase tracking-widest text-[10px] mt-2">Manage employee profile change requests</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative">
            ...
            <input 
              className="pl-10 pr-4 py-2.5 bg-muted/30 border border-border rounded-xl focus:ring-2 ring-primary/20 outline-none text-xs font-bold w-full sm:w-64"
